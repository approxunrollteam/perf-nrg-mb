...
<#if smile_classifiers_AdaBoost_262??>
        ${smile_classifiers_AdaBoost_262}
<#else>
        for (int i = 0; i < n; i++) {
            w[i] = 1.0;
        }
        ...
        for (int t = 0; t < ntrees; t++) {
            double W = Math.sum(w);
<#if smile_classifiers_AdaBoost_275??>
            ${smile_classifiers_AdaBoost_275}
<#else>
            for (int i = 0; i < n; i++) {
                w[i] /= W;
            }
...
<#if smile_classifiers_AdaBoost_287??>
            ${smile_classifiers_AdaBoost_287}
<#else>
            for (int i = 0; i < n; i++) {
...
<#if smile_classifiers_AdaBoost_324??>
            ${smile_classifiers_AdaBoost_324}
<#else>
