...
<#if smile_classifiers_DecisionTree_494??>
            ${smile_classifiers_DecisionTree_494}
<#else>
            for (int i = 0; i < p; i++) {
                variables[i] = i;
            }
...
<#if smile_classifiers_DecisionTree_618??>
                        ${smile_classifiers_DecisionTree_618}
<#else>
                        for (int l = 0; l < k; l++) {
...
<#if smile_classifiers_DecisionTree_713??>
            ${smile_classifiers_DecisionTree_713}
<#else>
            for (int i = 0; i < k; i++) {
...
<#if smile_classifiers_DecisionTree_967??>
        ${smile_classifiers_DecisionTree_967}
<#else>
        for (int i = 0; i < k; i++) {
