...
final class SegmentTermsEnumFrame {
  ...
  public void decodeMetaData() throws IOException {
    ...
    while (metaDataUpto < limit) {
      ...
      // metadata
      <#if org_apache_lucene_codecs_blocktree_SegmentTermsEnumFrame_decodeMetaData_460??>
          ${org_apache_lucene_codecs_blocktree_SegmentTermsEnumFrame_decodeMetaData_460}
      <#else>
