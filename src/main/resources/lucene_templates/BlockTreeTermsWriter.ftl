...
public final class BlockTreeTermsWriter extends FieldsConsumer {
  ...
  class TermsWriter {
    ...
    private void pushTerm(BytesRef text) throws IOException {
      ...
      // Init new tail:
      <#if org_apache_lucene_codecs_blocktree_BlockTreeTermsWriter$TermsWriter_pushTerm_917?? >
        ${org_apache_lucene_codecs_blocktree_BlockTreeTermsWriter$TermsWriter_pushTerm_917}
      <#else>
