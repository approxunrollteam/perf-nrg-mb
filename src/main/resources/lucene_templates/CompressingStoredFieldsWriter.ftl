...
public final class CompressingStoredFieldsWriter extends StoredFieldsWriter {
  ...
  private void flush() throws IOException {
    ...
    <#if org_apache_lucene_codecs_compressing_CompressingStoredFieldsWriter_flush_222??>
      ${org_apache_lucene_codecs_compressing_CompressingStoredFieldsWriter_flush_222}
    <#else>
