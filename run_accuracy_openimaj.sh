...
cd /home/elmarce/MarcelStuff/DATA/APPROX-UNROLL/INPUT_PROGRAMS/SOURCE/openimaj-master/thirdparty/
mvn clean
...
cd /home/elmarce/MarcelStuff/DATA/APPROX-UNROLL/INPUT_PROGRAMS/SOURCE/openimaj-master/core/core-image/
mvn clean
mvn install -Dmaven.test.skip=true -Dmaven.javadoc.skip=true
...
cd /home/elmarce/MarcelStuff/DATA/APPROX-UNROLL/INPUT_PROGRAMS/SOURCE/openimaj-master/image/
mvn clean
mvn install -Dmaven.test.skip=true -Dmaven.javadoc.skip=true
